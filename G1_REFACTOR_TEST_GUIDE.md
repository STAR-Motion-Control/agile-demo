...
新版使用 `runtime-refactor-v1` 当前 HEAD，基于 `g001-runtime-refactor-v1.3.3`。本次 rclpy 兼容修复按现场要求不新建标签。
...
- 当前分支为 `runtime-refactor-v1`，HEAD 包含 rclpy 兼容修复。
...
```text
日期/操作员：
部署分支：runtime-refactor-v1（基于 g001-runtime-refactor-v1.3.3）
