...
class CommandsCfg:
    ...
    height = mdp.SmoothHeightCommandCfg(
        ...
        ranges=mdp.SmoothHeightCommandCfg.Ranges(height=(0.55, unitree_g1.DEFAULT_PELVIS_HEIGHT + 0.2)),  # sit-not-lie: floor -0.5 -> 0.55 (deep upright sit, no lying targets)
        velocity_range=(1000.0, 1000.0),  # instant height jumps (no ramp)
        debug_vis=True,
        standing_ratio=0.3,
        flat_ratio=0.0,  # sit-not-lie: was 0.2 (no explicit lie-flat command)
        settle_time_s=2.0,
    )
...
class RewardsCfg:
    ...
    torso_upright = RewTerm(
        ...
        params={
            ...
            "standing_height_threshold": 0.2,  # sit-not-lie: enforce upright torso down to sit height (was 0.4)
    ...
    severely_tilted = RewTerm(
        ...
        params={
            ...
            "threshold_rad": math.radians(75),  # sit-not-lie: forbid lying (135 -> 75 deg from vertical)
        },
    )
    torso_roll = RewTerm(
