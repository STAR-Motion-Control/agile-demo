...
class LiftAction(ActionTerm):
    ...
    def apply_actions(self) -> None:
        ...
        if hasattr(self._asset, "permanent_wrench_composer"):
            ...
            # Isaac Lab 2.2.x fallback: no permanent_wrench_composer API.
            # Apply lift wrench via legacy external-wrench API (force-application offset is dropped).
            self._asset.set_external_force_and_torque(
                forces=forces_b, torques=torques_b, body_ids=self._lift_link_id
            )
